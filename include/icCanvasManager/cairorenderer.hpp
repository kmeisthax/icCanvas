#ifndef __ICCANVASMANAGER_CAIRORENDERER_HPP__
#define __ICCANVASMANAGER_CAIRORENDERER_HPP__
...
namespace icCanvasManager {
     ...
     * transparent circles.
     */
    class CairoRenderer : public virtual RefCnt, public virtual Renderer {
