...
namespace icCanvasManager {
    ...
    public class CanvasView {
        ...
        public void set_scroll_center(int x, int y);
        public void set_zoom(int vpixel_size);
        
        public void mouse_down(int x, int y, int deltaX, int deltaY);
        public void mouse_drag(int x, int y, int deltaX, int deltaY);
        public void mouse_up(int x, int y, int deltaX, int deltaY);
    }
